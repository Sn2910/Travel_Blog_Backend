...
app.get("/api/destinations/:id", (req, res) => {
  const { id } = req.params;
  getOneDestination(id).then((data) => {
    res.json(data);
  });
  /* .catch((err) => sendErrorOutput(err, res)); */
});
...
app.patch("/api/destinations/:id", (req, res) => {
  ...
  patchTable("destinations", fieldMapping, id, req).then(() => {
...
app.patch("/api/hotel/:id", (req, res) => {
  ...
  update.destinationID = update.destinationID
    ? parseInt(update.destinationID)
    : null;
  ...
  patchTable("hotels", fieldMapping, id, req).then(() => {
    res.send({ status: "updated" });
  });
  /* .catch((err) => sendErrorOutput(err, res)); */
});
